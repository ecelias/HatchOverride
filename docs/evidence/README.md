...
Do not add private identifiers, credentials, proprietary captures, or unrelated personal data. The admission procedure and sanitization checklist are defined by PROJ-002; until then, this layout contains no captures.
